...
urlpatterns = [
    ...
    url(r'^admin_modifier_professeur/(?P<user_id>[0-9]+)/(?P<admin_id>[0-9]+)/$', views.admin_modifier_professeur,
    ...
    url(r'^admin_supprimer_professeur/(?P<user_id>[0-9]+)/(?P<admin_id>[0-9]+)/$', views.admin_supprimer_professeur,
        name='admin_supprimer_professeur'),
    url(r'^admin_supprimer_etudiant/(?P<user_id>[0-9]+)/(?P<admin_id>[0-9]+)/$', views.admin_supprimer_etudiant,
